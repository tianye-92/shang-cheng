...
INSERT  INTO `au_user`(`id`,`loginCode`,`password`,`password2`,`userName`,`sex`,`birthday`,`cardType`,`cardTypeName`,`idCard`,`country`,`mobile`,`email`,`userAddress`,`postCode`,`createTime`,`referId`,`referCode`,`roleId`,`roleName`,`userType`,`userTypeName`,`isStart`,`lastUpdateTime`,`lastLoginTime`,`bankAccount`,`bankName`,`accountHolder`,`idCardPicPath`,`bankPicPath`) VALUES (2,'admin','123456','123456','系统管理员','女','2000-11-25','1','身份证','123456','中国','13522614019','123@hanlu.com','北京市成府路207号北大青鸟楼二层111','121212','2014-03-03 00:00:00',1,'admin',1,'管理员','','',1,'2014-04-09 16:27:54','2014-04-10 16:29:08','3423423432432','中国银行','张果','//statics/upLoadFiles/836312_IDcard.jpg','//statics/upLoadFiles/559357_bank.jpg'),(73,'JBIT','123456','123456','北大青鸟','','2011-04-10','1','身份证','123456','中国','123456','','','','2014-04-10 00:00:00',2,'admin',2,'会员','1','注册会员',1,'2014-04-10 14:41:14','2014-04-10 15:15:26','123456','北京银行','北大青鸟','/statics/upLoadFiles/143528_IDcard.jpg','/statics/upLoadFiles/707026_bank.jpg');
...
SELECT COUNT(1) FROM au_user WHERE roleId = 2
SELECT * FROM au_user WHERE loginCode LIKE CONCAT('%','b','%')



SELECT COUNT(1) FROM goods_pack_affiliated WHERE goodsInfoId = 14
